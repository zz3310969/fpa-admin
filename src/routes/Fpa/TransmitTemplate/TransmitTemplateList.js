...
import TransmitTemplateTable from './TransmitTemplateTable';
...
export default class TableList extends PureComponent {
  ...
  render() {
    const { transmittemplate: { loading: transmittemplateLoading, data } } = this.props;
    const { selectedRows } = this.state;
      ...
      <PageHeaderLayout title="分享模板列表">
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <TransmitTemplateTable
              selectedRows={selectedRows}
              loading={transmittemplateLoading}
              data={data}
