...
export default class TableList extends PureComponent {
  ...
  render() {
    const { card: { loading: cardLoading, data } } = this.props;
    const { selectedRows } = this.state;
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Button icon="plus" type="primary" onClick={() => {this.props.dispatch(routerRedux.push('/card/add')); console.log('新建')}}>新建</Button>
              {
