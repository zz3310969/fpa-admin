...
export default class TableList extends PureComponent {
  ...
  render() {
    const { refund: { loading: refundLoading, data } } = this.props;
    const { selectedRows } = this.state;
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Button icon="plus" type="primary" onClick={() => {this.props.dispatch(routerRedux.push('/refund/add')); console.log('新建')}}>新建</Button>
              {
