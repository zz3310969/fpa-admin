...
import CustomerWordsTable from './CustomerWordsTable';
...
export default class TableList extends PureComponent {
  ...
  render() {
    const { customerwords: { loading: customerwordsLoading, data } } = this.props;
    const { selectedRows } = this.state;
