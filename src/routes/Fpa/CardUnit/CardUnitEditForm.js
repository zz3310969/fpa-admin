...
export default class BasicForms extends PureComponent {
  ...
  render() {
    const { cardunit: { regularFormSubmitting:submitting, formdate } } = this.props;
          ...
          >
              ...
              >
                  {getFieldDecorator('imageBig', {
                    initialValue:formdate.imageBig,
                    rules: [{
              ...
              >
                  {getFieldDecorator('imageMid', {
                    initialValue:formdate.imageMid,
                    rules: [{
              ...
              >
                  {getFieldDecorator('imageSmall', {
                    initialValue:formdate.imageSmall,
                    rules: [{
              ...
              >
                  {getFieldDecorator('unitType', {
                    initialValue:formdate.unitType,
                    rules: [{
