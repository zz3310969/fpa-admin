...
import CardUnitTable from './CardUnitTable';
...
export default class TableList extends PureComponent {
  ...
  render() {
    const { cardunit: { loading: cardunitLoading, data } } = this.props;
    const { selectedRows } = this.state;
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Button icon="plus" type="primary" onClick={() => {this.props.dispatch(routerRedux.push('/cardunit/add')); console.log('新建')}}>新建</Button>
              {
