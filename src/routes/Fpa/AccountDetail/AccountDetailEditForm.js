...
export default class BasicForms extends PureComponent {
  ...
  render() {
    const { accountdetail: { regularFormSubmitting:submitting, formdate } } = this.props;
          ...
          >
              ...
              >
                  {getFieldDecorator('beforeAmount', {
                    initialValue:formdate.beforeAmount,
                    rules: [{
              ...
              >
                  {getFieldDecorator('afterAmount', {
                    initialValue:formdate.afterAmount,
                    rules: [{
