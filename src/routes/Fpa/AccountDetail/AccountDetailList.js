...
export default class TableList extends PureComponent {
  ...
  render() {
    const { accountdetail: { loading: accountdetailLoading, data } } = this.props;
    const { selectedRows } = this.state;
    ...
    return (
      <PageHeaderLayout title="账户金额变更详情列表">
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Button icon="plus" type="primary" onClick={() => {this.props.dispatch(routerRedux.push('/accountdetail/add')); console.log('新建')}}>新建</Button>
              {
