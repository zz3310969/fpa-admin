...
import AdvisoryModesTable from './AdvisoryModesTable';
...
export default class TableList extends PureComponent {
  ...
  renderAdvancedForm() {
    const { advisorymodes: { status, apps} } = this.props;
  ...
  render() {
    const { advisorymodes: { loading: advisorymodesLoading, data } } = this.props;
    const { selectedRows } = this.state;
