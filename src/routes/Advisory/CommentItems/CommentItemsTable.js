...
class StandardTable extends PureComponent {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: '展现方式',
        dataIndex: 'prosetaionTypeText',
        key: 'prosetaionTypeText',
      },
      {
        title: '状态',
        dataIndex: 'status',
      ...
      {
        title: '评价模版',
        dataIndex: 'commentTemplateName',
        key: 'commentTemplateName',
      },
      {
        title: '操作',
        render: (text, record, index) => (
          <div>
            <Link to={'/advisory/commentitems/edit/' + record.id + '?read=true'}>查看</Link>
            <Divider type="vertical"/>
            <Link to={'/advisory/commentitems/edit/' + record.id}>编辑</Link>
            <Divider type="vertical"/>
